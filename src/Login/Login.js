...
return(
    <React.Fragment>
        <div  className="h-screen overflow-auto flex items-center justify-center">
            <div className="w-full max-h-screen flex items-center justify-center">
                <div className="w-full h-screen flex items-center justify-center">
                    <div
                        className="w-full sm:w-5/6 md:w-full lg:w-1/2 xl:w-1/3 2xl:w-1/4 h-full bg-white flex items-center justify-center bg-gradient-to-r from-indigo-100 to-indigo-400 ">
                        <div className="w-full px-12 h-full">
                            ...
                            <p className="text-center text-sm text-gray-600 mt-2">
                                ...
                                <a href="register.html" className="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Sign
                                    in here</a>
                            </p>
                    ...
                    <form className="my-8 text-sm">
                                    <div className="flex flex-col my-4">
                                        <label htmlFor="emailLogin" className="text-gray-700">Email Address <span> 
                                    ...
                                    <div className="flex flex-col my-4">
                                        <label htmlFor="passwordLogin" className="text-gray-700">Password <span>
                                            <i className="fas fa-exclamation-circle failure-icon"></i>
                                            <i className="fas fa-check-circle success-icon"></i>
                                        </span></label>
                                    ...
                                    <div className="my-4 flex items-center justify-end space-x-4">
                                        <a href="register.html" className="text-blue-600 hover:text-blue-700 hover:underline" title="Forgot Password">Forgot Password?</a>
                                    </div>
                                </form>
                    ...
                    <div className="text-sm">
                        ...
                        <a href="#"
                            className="flex items-center justify-center space-x-2 text-gray-600 my-2 py-2 bg-gray-100 hover:bg-gray-200 rounded">
                            <svg fill="#1C2033" className="w-5 h-5" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="hidden lg:flex lg:w-1/2 xl:w-2/3 2xl:w-3/4 h-full bg-cover">
                    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-50">
                        <div className="flex items-center justify-center space-x-2">
                            <img src="./img/logo/logo-CP.svg" alt="Logo PassCode"  width="600" height="550"/> 
                        </div>
                        <p className="text-gray-500 mt-4 px-16 text-center">
                            Start building amazing MarkDown documents with PassCode, share your projects with
                            your team just with one click.
                        </p>
                        <a href="index.html"
        ...
        <script type="module" src="./js/js-login/mainLogin.js"></script>
