                ...
                <div className="w-full h-screen flex items-center justify-center">
                    <div className="overflow-auto w-full sm:w-5/6 md:w-2/3 lg:w-1/2 xl:w-1/3 2xl:w-1/4 h-full bg-white flex items-center justify-center bg-gradient-to-r from-indigo-100 to-indigo-400">
                        <div className="w-full px-12 max-h-full">
                            <h2 className="mt-6 text-center text-2xl font-bold tracking-wide text-gray-800">  Create your account  </h2>
                            <p className="text-center text-sm text-gray-600 mt-2">
                                Already have an account?
                                <a href="login.html" className="text-blue-600 hover:text-blue-700 hover:underline"title="Sign In" >Login in here</a >
                            </p>
                            <form className="my-8 text-sm">
                                <div className="flex flex-col my-4">
                                    ...
                                    <span
                                        ...
                                        <i className="fas fa-check-circle success-icon"></i></span >
                                </label>
                                    <input
                                    type="text"
                                    name="nameUp"
                                ...
                                <div className="flex flex-col my-4">
                                    ...
                                    <span>
                                        <i
                                        className="fas fa-exclamation-circle failure-icon relative"
                                        ></i>
                                        <i
                                        className="fas fa-check-circle success-icon relative"
                                        ></i></span >
                                    </label>
                                    <input
                                    type="email"
                                ...
                                <div dangerouslySetInnerHTML={{__html: confirmTemplate}}></div>

                                <div className="flex items-center">
                                    <input type="checkbox" name="termsUp" id="termsUp" className="mr-2 focus:ring-0 rounded"/>
                                    ...
                                    <label htmlFor="termsUp" className="text-gray-700" >
                                        ...
                                        <span ><i className="fas fa-exclamation-circle failure-icon relative"   ></i>
                                        <i className="fas fa-check-circle success-icon relative" ></i></span>
                                    </label>
                                </div>
                                <div className="error relative flex-col"></div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm uppercase mx-6 text-gray-800">Or</span>
                                <div className="w-full h-[1px] bg-gray-500"></div>
                            </div>
                    ...
                    <div className="hidden lg:flex lg:w-1/2 xl:w-2/3 2xl:w-3/4 h-full bg-cover">
                        ...
                        >
                            ...
                            Start building amazing documents with PassCode, share your projects with
