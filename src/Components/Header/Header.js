        ...
        <React.Fragment>
            ...
            <div className="flex items-center md:order-2">
                ...
                <ul className="py-2" aria-labelledby="user-menu-button">
                    ...
                    <li>
                    <a onClick={()=>{submitLogout()}} className="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
                    </li>
                </ul>
