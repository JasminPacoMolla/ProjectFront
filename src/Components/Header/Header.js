        ...
        <React.Fragment>
            ...
            <div className="flex items-center md:order-2">
                ...
                <ul className="py-2" aria-labelledby="user-menu-button">
                    ...
                    <li>
                    <a href="#"onClick={()=>{submitLogout()}} className="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
                    </li>
                </ul>
            ...
            <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-zinc-300 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-indigo-500 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                <Link to="/" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-indigo-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Delete Account</Link>
                </li>
            </ul>
            </div>
            </div>
