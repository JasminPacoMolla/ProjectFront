          ...
          <div className="row items-center">
            <div className="w-full">
              <nav className="flex items-center justify-between py-4 navbar navbar-expand-lg">
                ...
                <div className="absolute left-0 z-20 hidden w-full px-5 py-3 duration-300 bg-white shadow lg:w-auto collapse navbar-collapse lg:block top-full mt-full lg:static lg:bg-transparent lg:shadow-none" id="navbarOne">
                  <ul id="nav" className="items-center content-start mr-auto lg:justify-end navbar-nav lg:flex">
					...
					<li className="nav-item ml-5 lg:ml-11">
						<a className="" href="user.html">User example</a>
					  </li>
					  <li className="nav-item ml-5 lg:ml-11">
						<a className="" href="admin.html">Admin example</a>
					  </li>
                  </ul>
                </div>
              </nav>
