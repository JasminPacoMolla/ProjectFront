  ...
  return (
    <React.Fragment>
      <section
        ...
        style={{ backgroundImage: "/img/hero/hero-bg.svg" }}
      >
        <div className="container">
          <div className="row flex items-center relative">
            <div className="w-full lg:w-1/2">
              <div className="hero-content mb-0 lg:mb-6">
                <h1 className="text-black mb-9 text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-6xl">
            ...
            <div className="w-full lg:w-1/2">
              <div className="hero-img pt-8 lg:pt-0">
                <img
                  src="assets/img/logo/logo-CP.svg"
                  alt=""
